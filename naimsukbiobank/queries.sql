...
select `variants`.`variant`
        ...
        #, `variants`.`n_het`
        #, `variants`.`n_hom_var`
        #,`3064_irnt_both_sexes`.`low_confidence_variant`
        #,`3064_irnt_both_sexes`.`ytx`
        ,`3064_irnt_both_sexes`.`beta`
        #,`3064_irnt_both_sexes`.`se`
        #,`3064_irnt_both_sexes`.`tstat`
        ,`3064_irnt_both_sexes`.`pval`
        from `uk_biobank`.`variants`
        inner join `uk_biobank`.`3064_irnt_both_sexes`
        on `variants`.`variant` = `3064_irnt_both_sexes`.`variant`
        where `variants`.`chr` = 1 and `variants`.`pos` >= 205100000 and `variants`.`pos` <= 205200000 and `3064_irnt_both_sexes`.`low_confidence_variant` <> 1;

SELECT * FROM uk_biobank.3064_irnt_both_sexes;
